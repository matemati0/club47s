...
const memberHighlights = [
  {
    title: "אירוע סגור השבוע",
    description: "חמישי 23:30 | כניסה בהזמנה אישית בלבד"
  },
  {
    title: "סטטוס חברות",
    description: "החברות שלך פעילה עד 31.12.2026"
  },
  {
    title: "קוד גישה לילי",
    description: "הקוד השבועי לאזור הפרטי: 4721"
  }
];

const memberUpdates = [
  "נפתחה הרשמה מוקדמת לערב החתימות הקרוב.",
  "טרקלין הקומה העליונה זמין כעת להזמנות פרטיות.",
...
function getStoreCopy(mode: StoreMode) {
  if (mode === "member") {
    return {
      ...
      title: "חנות חבר מועדון",
      subtitle: "מוצרים נבחרים להזמנה מהירה במסלול חברים.",
      meta: "כרטיסי מוצר | דרופדאון חבילות | סל קניות עם סיכום פריטים",
      orderIntro: "שלום, אני חבר מועדון ומעוניין לבצע הזמנה:",
  ...
  return {
    ...
    title: "סודות החשק",
    subtitle: "מוצרים טבעיים וגנריים לתשוקה, אינטימיות וחיוניות",
    meta: "איכות גבוהה | שירות דיסקרטי | משלוחים מהירים",
    orderIntro: "שלום, אני מעוניין לבצע הזמנה:",
    cartTitle: "עגלה"
  };
}
